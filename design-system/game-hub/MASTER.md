...
**Project:** Game Hub
**Generated:** 2026-05-29 20:57:05
**Category:** Gaming

---

## Global RulesTypography: Inter / Inter

### Color Palette

| Role       | Hex       | CSS Variable         |
| ---------- | --------- | -------------------- |
| Background | `#080b14` | `--color-background` |
| Surface 1  | `#0f1320` | `--color-surface-1`  |
| Surface 2  | `#161b2e` | `--color-surface-2`  |
| Text       | `#f1f5f9` | `--color-text`       |
| Accent     | `#8b5cf6` | `--color-accent`     |
| CTA/Accent | `#8b5cf6` | `--color-cta`        |

**Color Notes:** Ultra dark OLED + violet accent. Per-game accent override dozvoljeno.
